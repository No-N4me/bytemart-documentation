...
- **[Plugins](plugins/index.md)** — der Plugin-Katalog, wie Plugins installiert
  werden und die Schlüssel `LicenseKey`, `Verbose`, `LogToFile` und `Database`,
  die alle Bytemart-Plugins gemeinsam haben.
